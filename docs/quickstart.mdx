...
### Option 2: Download the Example Directory

You can also download just the example directory from our GitHub repository:

1. Visit [https://github.com/orionjs/orionjs](https://github.com/orionjs/orionjs)
2. Navigate to the `example` directory
3. Download the files or use GitHub's download option
